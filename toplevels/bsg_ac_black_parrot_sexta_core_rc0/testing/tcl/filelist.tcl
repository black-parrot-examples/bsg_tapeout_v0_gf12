...
set TESTING_SOURCE_FILES [join "
  ...
  $bp_me_dir/test/common/bp_mem_dramsim2.v
  $bp_me_dir/test/common/bp_cce_mmio_cfg_loader.v
  $bp_me_dir/test/common/dramsim2_wrapper.cpp
  $bp_me_dir/src/v/wormhole/bp_me_cce_to_wormhole_link_async_master.v
  $bp_me_dir/src/v/wormhole/bp_me_cce_to_wormhole_link_async_client.v
