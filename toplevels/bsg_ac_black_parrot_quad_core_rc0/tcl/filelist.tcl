...
set SVERILOG_SOURCE_FILES [join "
  ...
  $bp_be_dir/src/v/bp_be_mem/bp_be_dcache/bp_be_dcache_lce_data_cmd.v
  ...
  $bp_be_dir/src/v/bp_be_mem/bp_be_dtlb/bp_be_dtlb.v
  $bp_be_dir/src/v/bp_be_mem/bp_be_dtlb/bp_be_dtlb_replacement.v
  $bp_be_dir/src/v/common/bsg_fifo_1r1w_fence.v
  ...
  $bp_me_dir/src/v/network/bp_me_network_pkt_encode_data_cmd.v
  $bp_me_dir/src/v/network/bp_me_network_pkt_encode_data_resp.v
  ...
  $bp_top_dir/src/v/bp_top.v
  $bp_top_dir/src/v/bp_core_complex.v
  $bp_top_dir/src/v/bp_addr_map.v
